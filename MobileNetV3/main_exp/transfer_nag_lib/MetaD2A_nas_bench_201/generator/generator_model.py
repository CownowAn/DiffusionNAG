...
import os
import sys
from transfer_nag_lib.MetaD2A_nas_bench_201.set_encoder.setenc_models import SetPool
...
class GeneratorModel(nn.Module):
    def __init__(self, args, graph_config):
        ...
        # from latent z to initial hidden state h0
        self.fc3 = nn.Linear(self.nz, self.hs)
